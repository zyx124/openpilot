...
class CarState(CarStateBase):
  ...
  def update_gen2(self, cp, cp_cam, cp_body):
    ...
    driver_torque = statistics.median([cp_body.vl["EPS_FEEDBACK"]["STEER_TORQUE_DRIVER"], # this is done to reduce noise/distortion and remove outliers due to a system faiure

...
from selfdrive.car.mazda.values import CAR, GEN1, GEN2, CarControllerParams
  ...
  def _get_params(ret, candidate, fingerprint, car_fw, experimental_long):
    ...
    if candidate in GEN1:
      ...
      if candidate not in (CAR.CX5_2022, ):
        ret.minSteerSpeed = CarControllerParams.DISABLE_SPEED * CV.KPH_TO_MS

    elif candidate in GEN2:
      ret.safetyConfigs = [get_safety_config(car.CarParams.SafetyModel.mazda, 1)]
      ret.dashcamOnly = candidate not in GEN2
